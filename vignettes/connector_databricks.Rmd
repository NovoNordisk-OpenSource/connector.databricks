---
title: "connector_databricks"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{connector_databricks}
...
* `connector_databricks_dbi$new()` function to authenticate and connect to your Databricks cluster
...
```{r, eval=FALSE}
metadata:
  catalog:  !!expr Sys.getenv("databricks_calatog")
...
Now, we will show how to read and write different types data from/to Databricks.
