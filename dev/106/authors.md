...
- **Oliver Lundsgaard**. Contributor.

- **Skander Mulder**. Contributor.
...
Source:
[`DESCRIPTION`](https://github.com/NovoNordisk-OpenSource/connector.databricks/blob/chore/use-pinned-workflow/DESCRIPTION)
